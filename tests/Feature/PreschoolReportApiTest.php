            ...
            ->assertJsonStructure([
                'data' => [
                    'dashboard' => [
                        ...
                        'risk',
                        'analytics' => [
                            'activeStudents' => ['current', 'previous', 'delta', 'percent', 'trend', 'comparison'],
                            'attendanceToday' => ['current', 'previous', 'delta', 'percent', 'trend', 'comparison'],
                            'openHealthAlerts' => ['current', 'previous', 'delta', 'percent', 'trend', 'comparison'],
                            'pendingEnrollments' => ['current', 'previous', 'delta', 'percent', 'trend', 'comparison'],
                            'outstandingPayments' => ['current', 'previous', 'delta', 'percent', 'trend', 'comparison'],
                        ],
                        'executiveHealth' => [
