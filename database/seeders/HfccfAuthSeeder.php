...
class HfccfAuthSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('roles')->insert([
            ...
            ['code' => 'adminscholaship', 'name' => 'Scholarship Admin', 'scope' => 'admin', 'domain_code' => 'scholarship', 'department_code' => 'education', 'sort_order' => 4],
        ...
        DB::table('permissions')->insert([
            ['code' => 'all:*', 'name' => 'Full system access'],
            ['code' => 'athletes:read', 'name' => 'Read athletes'],
            ['code' => 'attendance:write', 'name' => 'Manage attendance'],
            ['code' => 'classes:write', 'name' => 'Manage classes'],
            ['code' => 'dashboard:read', 'name' => 'Read dashboard'],
            ['code' => 'programs:write', 'name' => 'Manage programs'],
            ['code' => 'reports:read', 'name' => 'Read reports'],
            ['code' => 'settings:read', 'name' => 'Read settings'],
            ['code' => 'students:read', 'name' => 'Read students'],
            ['code' => 'students:write', 'name' => 'Manage students'],
            ['code' => 'tasks:read', 'name' => 'Read tasks'],
            ['code' => 'tasks:write', 'name' => 'Manage tasks'],
            ['code' => 'training:write', 'name' => 'Manage training'],
        ...
        DB::table('role_permissions')->insert([
            ...
            ['role_code' => 'adminscholaship', 'permission_code' => 'dashboard:read'],
            ['role_code' => 'adminscholaship', 'permission_code' => 'users:read'],
            ['role_code' => 'adminscholaship', 'permission_code' => 'users:write'],
            ['role_code' => 'adminscholaship', 'permission_code' => 'reports:read'],
            ['role_code' => 'adminscholaship', 'permission_code' => 'settings:read'],
