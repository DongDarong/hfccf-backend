...
class PreschoolMonthlyAttendanceReportDownloadController extends Controller
{
    public function __invoke(Request $request, PreschoolMonthlyAttendancePdfService $service): Response|JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Attendance PDF rendering is temporarily unavailable.',
                'data' => null,
