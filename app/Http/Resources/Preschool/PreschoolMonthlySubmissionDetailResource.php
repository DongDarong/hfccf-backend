...
class PreschoolMonthlySubmissionDetailResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'assessments' => PreschoolStudentAssessmentResource::collection($this->studentAssessments ?? []),
            'assessment_count' => $this->studentAssessments?->count() ?? 0,
            'grading_scale_snapshot' => $this->when(
                $this->status === 'finalized',
                $this->grading_scale_snapshot
            ),
