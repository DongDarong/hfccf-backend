...
class UpdateSportEventRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'event_type' => ['sometimes', 'required', 'in:goal,assist,yellow_card,red_card,substitution,substitution_in,substitution_out,injury,penalty_goal,penalty_miss,penalty_missed,own_goal,extra_time_goal'],
