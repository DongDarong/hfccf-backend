...
class StoreSportTournamentRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'tournament_type' => $this->input('tournament_type', $this->input('tournamentType', $this->input('sport_type', 'league'))),
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['sometimes', 'nullable', 'string', 'max:64', 'unique:sport_tournaments,slug'],
            ...
            'status' => ['required', 'in:draft,registration_open,registration_closed,group_draw_completed,fixtures_generated,active,knockout_stage,completed,archived'],
