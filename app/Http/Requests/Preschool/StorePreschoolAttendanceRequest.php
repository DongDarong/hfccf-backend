...
class StorePreschoolAttendanceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'class_id' => ['required_without:attendance_session_id', 'nullable', 'integer', 'exists:preschool_classes,id'],
            'student_id' => ['required', 'integer', 'exists:preschool_students,id'],
            'attendance_date' => ['required_without:attendance_session_id', 'nullable', 'date'],
